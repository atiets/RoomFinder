...
const PaymentPage = () => {
  ...
  const paymentMethods = [
    ...
    },
    {
      ...
      available: false,
      image:
        "https://static.chotot.com/storage/CT_WEB_UNI_PAYMENT_DASHBOARD/fd1a518195b786bf2b400842413324cd3059c5da/dist/cf5b4dd0bc1a29f352aad9aa476dffad.png",
    },
  ];
        ...
        <CardContent>
          ...
          <Alert severity="info" sx={{ mt: 3, mb: 3 }}>
            <Typography variant="body2">
              ...
              sẽ được kích hoạt ngay lập tức. Bạn sẽ nhận được email xác nhận và
              có thể sử dụng đầy đủ các tính năng của gói đã chọn.
            </Typography>
          </Alert>
