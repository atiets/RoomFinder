...
import { getAllSubscriptions, getCurrentSubscription } from '../../redux/subscriptionService';
...
const SubscriptionPage = () => {
    ...
    const loadData = async () => {
        try {
            ...
            if (accessToken && typeof accessToken === 'string') {
                ...
                console.log('⚠️ No valid access token, skipping getCurrentSubscription');
            }
        } catch (err) {
    ...
    const handleSelectPlan = (subscription) => {
        ...
        if (subscription.name === 'free') {
            ...
            // Navigate đến trang payment với query params
                ...
                features: [
                    ...
                    subscription.features.vipPosts === -1 
                        ...
                        : subscription.features.vipPosts > 0 
                            ...
                            : 'Không có tin VIP',
                    subscription.features.canViewHiddenPhone ? 'Xem số điện thoại ẩn' : '',
            ...
            console.log('🚀 Navigating to payment page with params:', queryParams.toString());
                ...
                <CardContent sx={{ p: 3 }}>
                    <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
                        ...
                        <Chip 
                            ...
                            icon={
                                isExpired ? <AccessTime /> :
                                isExpiringSoon ? <AccessTime /> : 
                                <CheckCircle />
                            }
                        />
                    </Box>
                    ...
                    <Grid container spacing={3}>
                        <Grid item xs={12} md={4}>
                            <Box>
                                ...
                                <Typography variant="h6" color={isExpiringSoon || isExpired ? 'error' : '#2e7d32'}>
                                    {daysRemaining} ngày
                                </Typography>
                            </Box>
                        </Grid>
                            ...
                            <Box mb={1}>
                                <Box display="flex" justifyContent="space-between" alignItems="center">
                                    <Typography variant="caption" color="#2e7d32">
                                        ...
                                        {subscriptionId.features.maxPosts > 0 && `/${subscriptionId.features.maxPosts}`}
                                    </Typography>
                                    <Typography variant="caption" color="#2e7d32">
                                ...
                                <LinearProgress 
                                    variant="determinate" 
                                    value={
                                        subscriptionId.features.maxPosts === -1 ? 0 :
                                        Math.min((currentUsage.postsCreated / subscriptionId.features.maxPosts) * 100, 100)
                                    }
                                    sx={{ 
                                        borderRadius: 2, 
                                        height: 8,
    ...
    const renderLoginPrompt = () => {
        ...
        return (
            <Alert severity="warning" sx={{ mb: 3, borderRadius: 2 }}>
                <Typography variant="body2">
                    🔐 Bạn cần <strong>đăng nhập</strong> để có thể đăng ký và sử dụng các gói dịch vụ.
                </Typography>
                <Button 
                    variant="contained" 
                    size="small" 
            ...
            <Box textAlign="center" mb={6}>
                ...
                >
                    ...
                    <Typography 
                        ...
                        sx={{ color: 'white' }}
                    >
                        Nâng cao trải nghiệm tìm kiếm và đăng tin với các gói dịch vụ đa dạng, 
                        phù hợp với mọi nhu cầu sử dụng
                    </Typography>
                </Box>
            </Box>
